...
export class HelpCenterService
{
    ...
    getAllPosts(): Observable<Array<PostModel>> {
        return this._httpClient.get<Array<PostModel>>('http://localhost:9000/pidev/posts');
      }

    getAllPostsInteractive(): Observable<Array<PostModel>> {
        return this._httpClient.get<Array<PostModel>>('http://localhost:9000/pidev/posts/most-interactive');
      }
    // -----------------------------------------------------------------------------------------------------
    // @ Accessors
    // -----------------------------------------------------------------------------------------------------
