...
export class DiscussionService {
  ...
  retrieveUsersForDiscussion(nom: string, prenom: string): Observable<User[]> {
    return this.http.get<User[]>(`${this.baseUrl}/retrieveUsersForDiscussion?prenom=${prenom}&nom=${nom}`);
  }
